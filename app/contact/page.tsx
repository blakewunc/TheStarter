      ...
      <div className="mx-auto max-w-2xl px-6 py-16">
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          ...
          <div className="rounded-[5px] border border-[#DAD2BC] bg-white p-6 shadow-[0_1px_3px_rgba(0,0,0,0.06)]">
            ...
            <h2 className="mb-1 font-semibold text-[#1C1A17]">Response Time</h2>
            <p className="mb-3 text-sm text-[#6B6460]">We typically respond within 1–2 business days.</p>
            <p className="text-sm text-[#6B6460]">For urgent issues with an active trip, mention it in your subject line and we'll prioritize.</p>
          </div>
        </div>

        <div className="mt-8 rounded-[5px] border border-[#DAD2BC] bg-white p-6 shadow-[0_1px_3px_rgba(0,0,0,0.06)]">
          <h2 className="mb-4 font-semibold text-[#1C1A17]">Frequently Asked Questions</h2>
          <div className="space-y-4">
            {[
              ...
              <div key={q} className="border-b border-[#F5F1ED] pb-4 last:border-0 last:pb-0">
                <p className="mb-1 font-medium text-[#1C1A17]">{q}</p>
                <p className="text-sm text-[#6B6460]">{a}</p>
              </div>
            ))}
          </div>
        </div>
