...
const CalendarIcon = () => (
  <svg className="h-7 w-7 text-[#3B6D11]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-[#F5F1ED] to-[#E8E3DD] px-4">
      <main className="mx-auto max-w-3xl text-center">
        ...
        <p className="mb-10 text-base text-[#1C1A17]">
        ...
        <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
          ...
          <Link href="/signup" className="text-sm text-[#3B6D11] underline-offset-2 hover:underline">
        ...
        <div className="mt-16 grid gap-6 sm:grid-cols-3">
          <div className="rounded-[5px] bg-white p-6 shadow-[0_1px_3px_rgba(0,0,0,0.06)] transition-shadow duration-300 hover:shadow-[0_2px_6px_rgba(0,0,0,0.08)]">
            ...
            <h3 className="mb-2 font-semibold text-[#1C1A17]">
              Shared Itineraries
            </h3>
